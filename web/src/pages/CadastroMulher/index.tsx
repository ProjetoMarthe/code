...
const CadastroMulher = () => {
    ...
    const history = useHistory(); // redirecionar o usuário depois do cadastro para a tela inicial
    ...
    // Enviar para a API o novo perfil cadastrado
    ...
    async function handleSubmit(event: FormEvent) { 
        ...
        alert('Bem vinda! Aguarde o nosso contato');
    ...
    return (
        <div id="page-cadastro-mulher">
            <header>
                {/* <img src={logo} alt="Marthe"/> */}
            ...
            <form onSubmit={handleSubmit}>
                <h1>Faça parte da <br />nossa iniciativa</h1>
                ...
                <fieldset className="field">
                    <legend>
                        <h2>Me conte sobre você</h2> 
                    </legend>

                    <label htmlFor="name">O que te levou a prostituição e que te motiva a sair dela?  Conte seus seus sonhos, ambições, dificuldades... Queremos te entender para melhor te ajudar  </label>
                    <textarea 
                        className="field"
                        id="informations"
                    />
                ...
                <fieldset>
                    <legend>
                        <h2>Endereço</h2>
                        <span>Selecione o seu endereço no mapa</span>
                    </legend>
                ...
                <fieldset>
                    <legend>
                        <div className="items-info">
                            <h2>O que você está precisando?</h2>
                            <p>Queremos te ajudar em qualquer obstáculo que dificulte a sua busca por uma nova oportunidade.</p>
                        </div>
